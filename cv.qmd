...
downloads[, formatted := glue::glue(
  ...
  a = csstyle::format_nor_num_0(signif(downloads_monthly, 1))
  )]
```
...
-   9 R packages as first author/maintainer:
...
-   1 Deprecated R package:
    -   [splutil](https://www.csids.no/splutil/) (`r downloads[package=="splutil"]$formatted` [cran](https://cloud.r-project.org/web/packages/splutil/index.html))
